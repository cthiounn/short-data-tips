...
To decode an image and display it in a Jupyter notebook

_Pour décoder une image et l'afficher dans un notebook Jupyter_
...
data_uri = f"data:image/png;base64,{utf_bytes_image}"
